import random
import csv
from utils import generate_random_zero_pairs, write_to_csv, generate_multiple_scenarios, round_to_nearest_hundred, generate_flag

FILENAME = "evaluation/data/scenarios/generated_scen_9.csv"
...
def generate_scenario():
    ...
    return generate_random_zero_pairs(1, 6) + pos_block + zero_rows + neg_block + generate_random_zero_pairs(1, 6)
