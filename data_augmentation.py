...
# File paths
INPUT_FILE = "training_data/vectorized_data.csv"   # Your input CSV file
TEMP_DIR = "temp_augmented_data"   # Temp directory
FINAL_OUTPUT_FILE = "training_data/augmented_data.csv"  # Merged output file
